...
@property (nonatomic, strong) ChartData * _Null_unspecified _data;
...
@property (nonatomic, readonly, strong) ChartAnimator * _Null_unspecified animator;
...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithXVals:(NSArray<NSObject *> * _Nullable)xVals dataSets:(NSArray<id <IChartDataSet>> * _Nullable)dataSets OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, strong) PieChartDataSet * _Nullable dataSet;
...
- (void)drawDataWithContext:(CGContextRef _Nonnull)context;
- (void)drawDataSetWithContext:(CGContextRef _Nonnull)context dataSet:(id <IRadarChartDataSet> _Nonnull)dataSet;
- (void)drawValuesWithContext:(CGContextRef _Nonnull)context;
- (void)drawExtrasWithContext:(CGContextRef _Nonnull)context;
...
@property (nonatomic, strong) RLMResults * _Nullable _results;
@property (nonatomic, copy) NSString * _Nullable _yValueField;
@property (nonatomic, copy) NSString * _Nullable _xIndexField;
@property (nonatomic, copy) NSArray<ChartDataEntry *> * _Nonnull _cache;
...
- (ChartDataEntry * _Nonnull)buildEntryFromResultObject:(RLMObject * _Nonnull)object atIndex:(NSUInteger)atIndex;
...
- (void)notifyDataSetChanged;
@property (nonatomic, copy) NSString * _Nullable _stackValueField;
- (ChartDataEntry * _Nonnull)buildEntryFromResultObject:(RLMObject * _Nonnull)object atIndex:(NSUInteger)atIndex;
- (void)calcMinMaxWithStart:(NSInteger)start end:(NSInteger)end;
...
@property (nonatomic, copy) NSString * _Nullable _sizeField;
@property (nonatomic) double _xMax;
@property (nonatomic) double _xMin;
@property (nonatomic) CGFloat _maxSize;
@property (nonatomic, readonly) double xMin;
...
@property (nonatomic, copy) NSString * _Nullable _highField;
@property (nonatomic, copy) NSString * _Nullable _lowField;
@property (nonatomic, copy) NSString * _Nullable _openField;
@property (nonatomic, copy) NSString * _Nullable _closeField;
- (ChartDataEntry * _Nonnull)buildEntryFromResultObject:(RLMObject * _Nonnull)object atIndex:(NSUInteger)atIndex;
- (void)calcMinMaxWithStart:(NSInteger)start end:(NSInteger)end;
